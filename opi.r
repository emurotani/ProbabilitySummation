...
opi.implementations <- list(
    ...
    list(
        name             = "SimRotterdam",
        opiInitialize    = "simR.opiInitialize",
        opiClose         = "simR.opiClose",
        opiSetBackground = "simR.opiSetBackground",
        opiQueryDevice   = "simR.opiQueryDevice",
        opiPresent       = "simR.opiPresent"
    ),
    list(
        name             = "SimRotterdamBinocular",
        opiInitialize    = "simRb.opiInitialize",
        opiClose         = "simRb.opiClose",
        opiSetBackground = "simRb.opiSetBackground",
        opiQueryDevice   = "simRb.opiQueryDevice",
        opiPresent       = "simRb.opiPresent"
    ),
    list(
        name             = "SimGaussian",
